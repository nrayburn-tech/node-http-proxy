...
let nativeAgents = { http: httpNative, https: httpsNative };
...
module.exports = {
  ...
  stream: function stream(req, res, options, _, server, clb) {
    ...
    let agents = options.followRedirects ? followRedirects : nativeAgents;
    let http = agents.http;
    let https = agents.https;
